...
export default function HomePageUI({ handleSubmit, ticker, setTicker }) {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 animate-gradient-flow text-white">
      {/* Logo */}
      ...
      >
        <input
          ...
          className="px-4 py-2 border rounded-md text-black text-lg text-center"
        />
        <button
          type="submit"
